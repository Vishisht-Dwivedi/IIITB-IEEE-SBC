...
const PhyBalls = () => {
    useEffect(() => {
        ...
        canvasArr.forEach((canvas) => {
            ...
            const colorArray = [
                "rgba(255, 218, 95, 0.6)",
                "rgba(255, 239, 200, 0.6)",
                "rgba(184, 213, 118, 0.6)",
                "rgba(54, 115, 181, 0.6)",
                "rgba(209, 248, 239, 0.6)",
            ];
            ...
            function boxCollisionHandling(circle) {
                if (
                    circle.x + circle.radius + circle.velocity.x >= CANVAS_WIDTH ||
                ...
                if (
                    circle.y + circle.radius + circle.velocity.y >= CANVAS_HEIGHT ||
            ...
            function init() {
                ...
                for (let i = 0; i < 15; i++) {
                    ...
                    if (window.innerWidth < 1000) {
                        ...
                        radius = randomInRange(0.06 * CANVAS_WIDTH, 0.1 * CANVAS_WIDTH);
                    }
