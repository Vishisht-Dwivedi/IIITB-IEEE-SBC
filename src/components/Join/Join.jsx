  ...
  return (
    <div className='Joins'>
        ...
        <div className='detail'>
            <h2>Conatct Us</h2>
            <div className='media'>
            <a href='#'><MdMailOutline size={25} />iiitbiee.org</a>
            </div>
            <div className='media'>
            <a href='#'><FaInstagram size={25}/>ieee_cs_iiitbpl</a>
            </div>
            <div className='media'>
            <a href=''><GrLocation size={30}/>NTB, Maulana Azad National Institute of Technology, Bhopal</a>
            </div>
            <div className='map'>
